...
def create_fresh_wallets_df(accumulators_df, filter_api):
    ...
    accumulators.rename(columns={'from_address':'Wallet', 'tokens_in':'Tokens In', 'tokens_out':'Tokens Out', 'received_from_cex':'From CEX', 'is_a_cex':'Is a CEX?', 'received_from_dex':'From DEX', 'min_time':'Creation Time'}, inplace=True)
